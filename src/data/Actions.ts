...
{
    name:"Psychic Power",
    effect:"Roll a d6, on 1 take 1 Damage. On a 2+, choose a psychic power from the Operative’s faction to use. If an enemy psyker is visible to you, they may take an Evade token if they don’t have one, to give you -1 to this roll."
}
