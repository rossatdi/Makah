...
{
    name:"Breakin' Heads",
    effect:"When this model is activated they may choose a friendly visible operative with an Evade token. That operative loses the token and takes d3 wounds.",
    pt:3
}
